...
```{r theme1,include=FALSE,echo=FALSE}
...
From the cleveland plot above, we can divide all occupations into three categories. The first group is in a monotonous increasing trend, the second group is in a monotonous decreasing trend, and the third group do not have a monotonous trend in number of employed people by years. 
