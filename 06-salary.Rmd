...
```{r Data2, include=FALSE,echo=FALSE}
...
```{r theme salary,include=FALSE,echo=FALSE}
...
```{r scale2,include=FALSE,echo=FALSE}
...
```{r Overview of Salary Distribution,fig.width=10,fig.align='center'}
ggplot(NewSalary) +
...
\
\
```{r Yearly Normalized BoxPlot2,fig.width=10,fig.height=6,fig.align='center'}
...
```{r,fig.height=11,fig.width=10,fig.align='center'}
...
We draw a side by side bar chart to reflect the specific distribution data of the highest and lowest wages in different counties.\
